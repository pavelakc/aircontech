...
function printInhausReport() {
  ...
  const cols_co2     = ['Ansul Seal','Stamp Date','TC Stamp','Stamp Weight','Hydro When','Actual Weight'];
...
<div class="page">
  ...
  <!-- N2 Cartridges -->
  <div class="section">
    <div class="section-header">🔵 N2 Cartridges (23/55 cu ft)</div>
    <div class="section-body">
  ...
  <!-- LT30 -->
  <div class="section">
    <div class="section-header">🟡 LT30 Information</div>
    <div class="section-body">
